        ...
        <>
            <div className="flex justify-between items-center flex-wrap gap-4 mb-4">
                <div className="flex gap-2">
                    ...
                    >
                        <svg className="mr-2 w-[18px] h-[18px]" fill="none" stroke="currentColor" strokeWidth="2"
                             viewBox="0 0 20 20">
                        ...
                        {section === 'plazos' && (
                            <section>
                                <div className="flex items-center justify-between mb-3">
                                    <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Plazos
                                        Fijos</h3>
                                    <a
                                        href="/simulator"
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {
                                        ...
                                        sortedPlazos.map((p, i) => {
                                            ...
                                            return p.enlace ? (
                                                ...
                                                >
                        <span
                            className="absolute top-3 right-3 bg-blue-100 text-blue-700 text-sm font-medium px-3 py-0.5 rounded-full border border-blue-200 dark:bg-blue-900 dark:text-blue-300 dark:border-blue-700">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {sortedBilleteras.map((b, i) => {
                                        ...
                                        return b.url ? (
                                            ...
                                            >
                      <span
                          className="absolute top-3 right-3 bg-purple-100 text-purple-700 text-sm font-medium px-3 py-0.5 rounded-full border border-purple-200 dark:bg-purple-900 dark:text-purple-300 dark:border-purple-700">
                        {b.tna.toFixed(2)}%
                      </span>
                                                <img
                                                    src={iconSrc}
                            ...
                            <span
                                className="bg-red-100 text-red-700 text-xs font-semibold px-3 py-0.5 rounded-full border border-red-200 dark:bg-red-900 dark:text-red-300 dark:border-red-700 shadow">
                        ...
                        {section === 'cripto' && (
                            <section>
                                ...
                                <div className="overflow-x-auto">
                                    <table
                                        className="table-auto w-full text-sm rounded-xl bg-white dark:bg-gray-900 shadow-md divide-y divide-gray-200 dark:divide-gray-700">
                                        <thead>
                                        <tr className="text-xs font-bold text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-800 uppercase text-center tracking-wide">
                                            ...
                                            {sortedCripto.map((entidad, idx) => {
                                                ...
                                                return (
                                                    <th key={idx}
                                                        className="px-4 py-3 text-center text-gray-800 dark:text-gray-100">
                                                        {entidad.url ? (
                                                            <a
                                                                href={entidad.url}
                                                                target="_blank"
                                                            ...
                                                            >
                                                                ...
                                                                />
                                                                <span
                                                                    className="text-xs font-medium text-gray-800 dark:text-gray-100">{entidad.entidad}</span>
                                                            </a>
                                                        ) : (
                                                            <div
