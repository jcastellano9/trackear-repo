            ...
            >
                <div
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed mt-2">Recuperar
                            contraseña</p>
                    </div>
                    ...
                    {success ? (
                        <div className="text-center">
                            <div
                                className="mb-4 p-4 bg-green-50 border border-green-200 rounded-lg flex items-center justify-center text-green-700 dark:bg-green-900 dark:border-green-600 dark:text-green-200">
                            ...
                            <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed mb-4">Revise su
                                bandeja de entrada y siga las instrucciones para restablecer su contraseña.</p>
                            <Link
                                to="/login"
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="space-y-4">
                                ...
                                >
                                    {loading ? (
                                        <span
                                            className="animate-spin rounded-full h-5 w-5 border-t-2 border-white"></span>
                                    ) : (
                                        <>
